...
(function () {
  ...
  var STATIONS = {
    ...
    s2: {
      ...
      resources: [
        { label: "SQL Roadmap", url: "https://github.com/SahilGogna/Study-Resources/blob/main/analysis/sql.md" },
        { label: "Practice Datasets", url: "https://github.com/SahilGogna/Study-Resources/blob/main/analysis/sql-75-datasets.sql" }
      ]
    },
    s3: {
      line: "SQL Line",
  ...
  function openPanel(stationId) {
    ...
    if (data.resources && data.resources.length > 0) {
      ...
      p.textContent = "Resources coming in the next video →";
